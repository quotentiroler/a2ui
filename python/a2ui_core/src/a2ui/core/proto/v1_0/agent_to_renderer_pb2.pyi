...
class CreateSurfaceMessage(_message.Message):
    ...
    def __init__(
        ...
        catalog_id: _Optional[str] = ...,
        send_data_model: _Optional[bool] = ...,
        components: _Optional[_Iterable[_Union[Component, _Mapping]]] = ...,
        data_model: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        metadata: _Optional[_Union[SurfaceMetadata, _Mapping]] = ...,
    ) -> None: ...
...
class AgentFunctionResponseMessage(_message.Message):
    ...
    def __init__(
        self,
        agent_function_response: _Optional[
...
class AgentToRendererMessage(_message.Message):
    ...
    def __init__(
        ...
        create_surface: _Optional[_Union[CreateSurfaceMessage, _Mapping]] = ...,
        update_components: _Optional[_Union[UpdateComponentsMessage, _Mapping]] = ...,
        update_data_model: _Optional[_Union[UpdateDataModelMessage, _Mapping]] = ...,
        delete_surface: _Optional[_Union[DeleteSurfaceMessage, _Mapping]] = ...,
        call_renderer_function: _Optional[
            _Union[CallRendererFunctionMessage, _Mapping]
        ] = ...,
        agent_function_response: _Optional[
            _Union[AgentFunctionResponseMessage, _Mapping]
        ] = ...,
    ) -> None: ...
