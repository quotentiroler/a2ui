...
class RendererCapabilitiesV1(_message.Message):
    ...
    inline_catalogs: _containers.RepeatedCompositeFieldContainer[
        _catalog_definition_pb2.CatalogDefinition
    ]
    def __init__(
        self,
        supported_catalog_ids: _Optional[_Iterable[str]] = ...,
        inline_catalogs: _Optional[
            _Iterable[_Union[_catalog_definition_pb2.CatalogDefinition, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class RendererCapabilities(_message.Message):
    ...
    def __init__(
        self, v1_0: _Optional[_Union[RendererCapabilitiesV1, _Mapping]] = ...
    ) -> None: ...
