...
class AccessibilityAttributes(_message.Message):
    ...
    def __init__(
        self,
        label: _Optional[_Union[DynamicString, _Mapping]] = ...,
        description: _Optional[_Union[DynamicString, _Mapping]] = ...,
        live: _Optional[_Union[LiveMode, str]] = ...,
        hidden: _Optional[_Union[DynamicBoolean, _Mapping]] = ...,
    ) -> None: ...
...
class Extensions(_message.Message):
    ...
    def __init__(
        self, fields: _Optional[_Mapping[str, _struct_pb2.Value]] = ...
    ) -> None: ...
...
class ComponentMetadata(_message.Message):
    ...
    def __init__(
        self, extensions: _Optional[_Union[Extensions, _Mapping]] = ...
    ) -> None: ...
...
class ComponentCommon(_message.Message):
    ...
    def __init__(
        ...
        accessibility: _Optional[_Union[AccessibilityAttributes, _Mapping]] = ...,
        metadata: _Optional[_Union[ComponentMetadata, _Mapping]] = ...,
    ) -> None: ...
...
class ChildListTemplate(_message.Message):
    ...
    path: str
    def __init__(
        self, component_id: _Optional[str] = ..., path: _Optional[str] = ...
    ) -> None: ...
...
class ChildList(_message.Message):
    ...
    def __init__(
        self,
        static_list: _Optional[_Union[StaticChildList, _Mapping]] = ...,
        template: _Optional[_Union[ChildListTemplate, _Mapping]] = ...,
    ) -> None: ...
...
class DynamicValue(_message.Message):
    ...
    def __init__(
        self,
        literal_string: _Optional[str] = ...,
        literal_number: _Optional[float] = ...,
        literal_boolean: _Optional[bool] = ...,
        literal_list: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ...,
        literal_object: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        data_binding: _Optional[_Union[DataBinding, _Mapping]] = ...,
...
class DynamicStringList(_message.Message):
    ...
    def __init__(
        self,
        literal_string_list: _Optional[_Union[StringList, _Mapping]] = ...,
        data_binding: _Optional[_Union[DataBinding, _Mapping]] = ...,
        function_call: _Optional[_Union[FunctionCall, _Mapping]] = ...,
    ) -> None: ...
...
class FunctionCall(_message.Message):
    ...
    class ArgsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[DynamicValue, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        call: _Optional[str] = ...,
        catalog_id: _Optional[str] = ...,
        args: _Optional[_Mapping[str, DynamicValue]] = ...,
    ) -> None: ...
...
class IndexSystemFunctionArguments(_message.Message):
    ...
    def __init__(
        self, offset: _Optional[_Union[DynamicNumber, _Mapping]] = ...
    ) -> None: ...
...
class Checkable(_message.Message):
    ...
    def __init__(
        self, checks: _Optional[_Iterable[_Union[CheckRule, _Mapping]]] = ...
    ) -> None: ...
...
class EventAction(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        user_message: _Optional[_Union[DynamicString, _Mapping]] = ...,
        context: _Optional[_Mapping[str, DynamicValue]] = ...,
    ) -> None: ...
...
class Action(_message.Message):
    ...
    def __init__(
        self,
        event: _Optional[_Union[EventAction, _Mapping]] = ...,
        function_call: _Optional[_Union[FunctionCall, _Mapping]] = ...,
    ) -> None: ...
...
class SurfaceContainer(_message.Message):
    ...
    child: str
    def __init__(
        self, component: _Optional[str] = ..., child: _Optional[str] = ...
    ) -> None: ...
