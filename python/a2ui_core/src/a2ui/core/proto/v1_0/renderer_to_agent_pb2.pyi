...
class ActionEventMessage(_message.Message):
    __slots__ = ("name", "user_message", "surface_id", "source_component_id", "timestamp", "context", "metadata")
    ...
    def __init__(self, name: _Optional[str] = ..., user_message: _Optional[str] = ..., surface_id: _Optional[str] = ..., source_component_id: _Optional[str] = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., context: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., metadata: _Optional[_Union[ActionMetadata, _Mapping]] = ...) -> None: ...
...
class CallAgentFunctionMessage(_message.Message):
    ...
    def __init__(self, surface_id: _Optional[str] = ..., function_call_id: _Optional[str] = ..., call_function: _Optional[_Union[_common_types_pb2.FunctionCall, _Mapping]] = ...) -> None: ...
...
class RendererFunctionResponseMessage(_message.Message):
    ...
    def __init__(self, renderer_function_response: _Optional[_Union[_common_types_pb2.FunctionResponse, _Mapping]] = ...) -> None: ...
...
class ValidationFailedError(_message.Message):
    ...
    path: str
    message: str
    def __init__(self, code: _Optional[_Union[ValidationFailedError.Code, str]] = ..., surface_id: _Optional[str] = ..., path: _Optional[str] = ..., message: _Optional[str] = ...) -> None: ...
...
class GenericError(_message.Message):
    ...
    def __init__(self, code: _Optional[str] = ..., message: _Optional[str] = ..., surface_id: _Optional[str] = ..., function_call_id: _Optional[str] = ..., details: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class RendererErrorMessage(_message.Message):
    ...
    def __init__(self, validation_error: _Optional[_Union[ValidationFailedError, _Mapping]] = ..., generic_error: _Optional[_Union[GenericError, _Mapping]] = ...) -> None: ...

class RendererToAgentMessage(_message.Message):
    __slots__ = ("version", "action", "call_agent_function", "renderer_function_response", "error")
    ...
    def __init__(self, version: _Optional[str] = ..., action: _Optional[_Union[ActionEventMessage, _Mapping]] = ..., call_agent_function: _Optional[_Union[CallAgentFunctionMessage, _Mapping]] = ..., renderer_function_response: _Optional[_Union[RendererFunctionResponseMessage, _Mapping]] = ..., error: _Optional[_Union[RendererErrorMessage, _Mapping]] = ...) -> None: ...
